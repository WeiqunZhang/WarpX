...
{
    int hack_deposit_order = WarpX::nox;
    if (dynamic_cast<LaserParticleContainer*>(this)) {
        amrex::ParmParse pp;
        pp.query("laser_shape", hack_deposit_order);
    }
